...
// MOSTRAR LOGIN SIEMPRE AL ENTRAR
            ...
            <div class="order-card" data-id="${order.id}">
                ...
                <div class="order-actions">
                    ${order.status === 'pendiente' ? `
                        <button class="status-btn btn-complete" onclick="completeOrder(${order.id})">
                            <i class="fas fa-check"></i> Marcar Completado
                        </button>
                    ` : ''}
                    <button class="status-btn btn-delete-order" onclick="deleteOrder(${order.id})">
                        <i class="fas fa-trash"></i> Eliminar
                    </button>
                </div>
            </div>
